...
class LA_Heart_Dataset(Dataset):
    """ LA Dataset """
    ...
    def __init__(self, base_dir=None, split='train', train_flod=None, common_transform=None, sp_transform=None):
        ...
        if split == 'train':
            ...
            # with open(self._base_dir + '/Flods/' + train_flod, 'r') as f:
            # with open("E:\Paper_Code\CJHF\dataset\LA\Flods\\train0.list", 'r') as f:
                self.image_list = f.readlines()
        else:
            with open(self._base_dir + '/../Flods/test0.list', 'r') as f:
                self.image_list = f.readlines()
...
# 自定义的 PyTorch 采样器，用于生成训练混合数据的批次
