...
from models.vnet import VNet,Projector_v,Classifier_v
from models.ResNet34 import Resnet34
from utils import ramps, losses
from dataloaders.Pancreas_Data import Pancreas, RandomCrop, ToTensor, TwoStreamBatchSampler
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch),ncols = 70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            v_outputs1_pro = v_out1['projector']  # torch.Size([4, 16, 112, 112, 80])
            ...
            if iter_num >= max_iterations:
                break
        logging.info('epoch',epoch_num,' time:',time.time()-time2)
